...
export const GAME_CATALOG = [...BOARD_GAME_CATALOG, { id: 'yacht', name: '요트 다이스', people: '1–4인', minPlayers: 1, maxPlayers: 4, time: '30분', tags: ['파티', '주사위'] }, { id: 'fleet', name: '함대 격침', people: '2인', minPlayers: 2, maxPlayers: 2, time: '30분', tags: ['파티', '전략'] }] as const;
