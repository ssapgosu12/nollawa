...
export type CatalogGameId = GameId | 'yacht' | 'fleet';
...
export const GAME_CATALOG = [...BOARD_GAME_CATALOG, { id: 'yacht', name: 'Yacht Dice', people: '1–4인', minPlayers: 1, maxPlayers: 4, time: '30분', tags: ['파티', '주사위'] }, { id: 'fleet', name: '함대 격침', people: '2–6인', minPlayers: 2, maxPlayers: 6, time: '30분', tags: ['파티', '전략'] }] as const;
export const isBoardGameId = (value: string): value is GameId => BOARD_GAME_CATALOG.some((game) => game.id === value);
